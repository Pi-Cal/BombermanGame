...
import uet.oop.bomberman.Character.Sound_cdjv;
    ...
    public void handleCollision() {
        ...
        while (i < items.size()) {
            if (bomberman.handle_1_Collision(items.get(i))) {
                if (items.get(i) instanceof BombItem) {
                    bomberman.addBomb(items.get(i));
                } else if (items.get(i) instanceof FlameItem) {
                    bomberman.addFlame(items.get(i));
                } else if (items.get(i) instanceof SpeedItem) {
                    bomberman.addSpeed(items.get(i));
                }
                Sound.bling.start();
